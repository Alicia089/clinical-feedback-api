...
Built by [Alicia Duncan](https://github.com/Alicia089)

[![CI/CD](https://github.com/Alicia089/clinical-feedback-api/actions/workflows/deploy.yml/badge.svg)](https://github.com/Alicia089/clinical-feedback-api/actions)
...
This API is the triage layer for CaseReady, a pre-surgery coordination platform for ASCs built by Alicia Duncan.
...
### Why DistilBERT over GPT-4 for inference?
...
```bash
git clone https://github.com/Alicia089/clinical-feedback-api.git
